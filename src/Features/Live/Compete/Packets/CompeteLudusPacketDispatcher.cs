...
namespace ScoreSaber.Features.Live.Compete.Packets {
    internal static class CompeteLudusPacketDispatcher {
        internal static LudusPacketDispatcher<ILudusSessionPacketContext> CreateDefault(ILudusServerCommandSession commandSession, LudusChatMessageBuffer chatMessages) {
